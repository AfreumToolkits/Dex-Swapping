...
export const SwapTokenContext = React.createContext({
  singleSwapToken: async () => {},
  connectWallet: async () => {},
  getPrice: async () => {},
  swapUpdatePrice: async () => {},
  createLiquidityAndPool: async () => {},
  getAllLiquidity: [],
  account: "",
  weth9: "",
  dai: "",
    ...
    try {
      ...
      if (userStorageData) {
        ...
        for (const el of userLiquidity) {
          ...
          if (liquidityData) {
            liquidityDataArray.push(liquidityData);
          }
        }
        setGetAllLiquidity(liquidityDataArray);
