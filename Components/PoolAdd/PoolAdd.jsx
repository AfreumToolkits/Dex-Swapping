...
import { Icons, Token, SearchToken } from "../../Components/index.js";
      ...
      <div className={Style.PoolAdd_box}>
        <div className={Style.PoolAdd_box_header}>
          ...
          <div className={Style.PoolAdd_box_header_right}>
            <p>
              {tokenOne.name || ""} {safeSlice(tokenOne.tokenBalance, 0, 9) || ""}
              {""}
              {""}
              {tokenTwo.name || ""} {safeSlice(tokenTwo.tokenBalance, 0, 9) || ""}
            </p>
            <Icons.Close
              width={50}
              height={50}
        ...
        <div className={Style.PoolAdd_box_price}>
          ...
          <div className={Style.PoolAdd_box_price_left}>
            ...
            <div className={Style.PoolAdd_box_price_left_token}>
              ...
              >
                <p>
                  <Icons.EtherLogo width={20} height={20} alt="image" />
                </p>
                ...
                {feePairs.map((el, i) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <p>
                        {active == i + 1 ? (
                          <Icons.Tick width={20} height={20} alt="image" />
                        ) : (
                          ""
                        )}
                      </p>
            ...
            <div className={Style.PoolAdd_box_deposit}>
              ...
              <div className={Style.PoolAdd_box_deposit_box}>
                <input
                  type="number"
                  placeholder={safeSlice(tokenOne.tokenBalance, 0, 9)}
              ...
              <div className={Style.PoolAdd_box_deposit_box}>
                <input
                  type="number"
                  placeholder={safeSlice(tokenTwo.tokenBalance, 0, 9)}
